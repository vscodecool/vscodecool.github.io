...
在VS Code中，做文件切换最方便的方式是使用快捷键<kbd>Ctrl</kbd>+<kbd>Tab</kbd>，它的具体使用方法是：1，按住<kbd>Ctrl</kbd>+<kbd>Tab</kbd>；2，不松<kbd>Ctrl</kbd>，依靠单击<kbd>Tab</kbd>选择文件；3，释放<kbd>Ctrl</kbd>打开被选文件。
