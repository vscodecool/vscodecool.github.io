...
- [73 文件使用技巧29: 搜索替换时使用正则表达式](#73-文件使用技巧29-搜索替换时使用正则表达式)
...
#### 73 文件使用技巧29: 搜索替换时使用正则表达式

这节课，我们来学习搜索时如何使用正则表达式。

为了利用正则表达式，首先需要点击搜索输入框最右侧的那个选项，之后我们就可以在搜索输入框中输入正则表达式了。

正则表达式规则有很多，我这里只列出一些常见的供大家参考：
